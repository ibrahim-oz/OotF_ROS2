#!/bin/bash
# =============================================================================
# launch_bridge.sh — Universal launch script for tcp_ros_bridge.py.
# Auto-detects ROS distro, Python, and Isaac Sim paths.
# Run from anywhere: bash launch/launch_bridge.sh
#
# If the Isaac Sim ROS workspace is in a non-standard location, set ISAAC_WS:
#   ISAAC_WS=/path/to/workspace bash launch/launch_bridge.sh
# =============================================================================
...
$PYTHON "$PROJECT_ROOT/src/tcp_ros_bridge.py"
